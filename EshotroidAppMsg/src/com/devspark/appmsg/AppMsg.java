...
public class AppMsg {
	...
	/**
	 * Show the text notification for a short period of time with a negative style.
	 */
	public static final Style STYLE_NEGATIVE = new Style(LENGTH_LONG, R.color.negative);
	
	/**
	 * Show the text notification for a short period of time with a neutral style.
	 */
	public static final Style STYLE_NEUTRAL = new Style(LENGTH_SHORT, R.color.neutral);
	
	/**
	 * Show the text notification for a short period of time with a positive style.
	 */
	public static final Style STYLE_POSITIVE = new Style(LENGTH_SHORT, R.color.positive);
